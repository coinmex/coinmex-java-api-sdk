package com.coinmex.dax.sdk.openapi.spot.publics.service;
...
public interface PublicService {
     ...
     *
     * @return com.coinmex.dax.sdk.openapi.spot.ccex.domain.ServerTime
     * @see ServerTime
     */
     ...
     * @param code 币对
     * @param size 返回数据条数
     * @return 订单深度信息 com.coinmex.dax.sdk.openapi.spot.ccex.domain.OrderBook
     * @see OrderBook
     */
     ...
     *
     * @return 币对信息列表 com.coinmex.dax.sdk.openapi.spot.ccex.domain.CodeInfo
     * @see CodeInfo
     */
